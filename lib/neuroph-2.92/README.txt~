...
This is the release 2.92 of the Java Neural Network Framework Neuroph
...
This is mostly maintainance release and brings bug fixes in the whole framework, source code quality improvements and improvements for ConvolutionalNetworks, both in framework  API, 
and NeurophStudio GUI.


USAGE

To use Neuroph in your Java appliacation add reference to neuroph-core-x.x.jar (and all other jars you want to use), and import required classes.
All aditional 3rd party libraries that are required are available in lib folder of this distribution.
...
Neuroph Sources at GitHub
	https://github.com/neuroph

Neuroph Maven Repository
	http://neuroph.sourceforge.net/maven2/
